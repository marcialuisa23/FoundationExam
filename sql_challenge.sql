...
-- There is no boolean data type in SQL Server.However, a common option is to use the BIT data type. A BIT data type is used to store bit values So, a BIT field can be used for booleans, providing 1 for TRUE and 0 for FALSE.

CREATE Table showings(
showing_ID INT NOT NULL UNIQUE, 
...
s. available_seats 
FROM showings s
JOIN movie_info m ON m.movie_name = s. movie_ID
